...
class TiTokTokenizer(nn.Module):
    def __init__(
        ...
        self.vq = VQ(
            dim=dim, codebook_dim=dim, codebook_size=codebook_size, **vq_kwargs
        )
        ...
        self.tokens_to_image = nn.Sequential(
            ...
            Rearrange(
                "b h w (c p1 p2) -> b c (h p1) (w p2)", p1=patch_size, p2=patch_size
            ),
        )
    ...
    def forward(
        ...
        return recon_images, indices, vq_loss
